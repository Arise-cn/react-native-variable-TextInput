...
exports.singleRegex = exports.regex = exports.getAttributedTextArr = exports.emojiPattern = exports.deletKeyBord = void 0;
/**
 * {"@"}[userName](id)
 */
const regex = /({[^{}[\]()]*}\[[^[\]()]*]\([^(){}]*\))/g;
exports.regex = regex;
const singleRegex = /{([^\]}]*)}\[([^\]]*)]\(([^)]*)\)/;
exports.singleRegex = singleRegex;
 ...
 */
exports.deletKeyBord = deletKeyBord;
...
exports.getAttributedTextArr = getAttributedTextArr;
